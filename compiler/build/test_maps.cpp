...
int main() {
    gom_print(GomValue(std::string("=== Testing Map/Dictionary Support ===")));
    const GomValue person = gom_Map();
    gom_print(GomValue(std::string("Created empty Map")));
    gom_print(GomValue(std::string("\n=== Testing Array Operations ===")));
    const GomValue numbers = GomValue(std::vector<GomValue>{GomValue(1.000000), GomValue(2.000000), GomValue(3.000000), GomValue(4.000000), GomValue(5.000000)});
    gom_print(GomValue(std::string("Array: [1, 2, 3, 4, 5]")));
    gom_print(GomValue(std::string("First element: ")));
    gom_print(gom_index_access(numbers, GomValue(0.000000)));
    gom_print(GomValue(std::string("Last element (using -1): ")));
