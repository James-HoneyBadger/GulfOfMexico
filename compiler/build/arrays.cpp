...
int main() {
    const GomValue list = GomValue(std::vector<GomValue>{GomValue(1.000000), GomValue(2.000000), GomValue(3.000000), GomValue(4.000000), GomValue(5.000000)});
    gom_print(gom_index_access(list, gom_unary_op("-", GomValue(1.000000))));
    gom_print(gom_index_access(list, GomValue(0.000000)));
}
